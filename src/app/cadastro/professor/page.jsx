...
export default function CadastroProfessor() {
  ...
  const handleCadastro = async (e) => {
    ...
    setIsLoading(true);
    try {
      await signUp(email, password, { full_name: nome, role: 'professor' });
      showToast('Conta de professor criada com sucesso! Verifique o seu email ou faça login.', 'success');
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-xl shadow-blue-900/5">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-extrabold text-slate-800 mb-1 tracking-tight">Registo de Professor</h1>
            <p className="text-slate-500 text-[12px] font-medium leading-snug">Junte-se à nossa plataforma académica</p>
          </div>
          ...
          <form onSubmit={handleCadastro} className="space-y-4">
            ...
            <div>
              <label className="block text-[12px] font-bold text-slate-700 mb-1.5">Email Institucional</label>
              <div className="relative group">
            ...
            >
              ...
              {!isLoading && <span className="material-symbols-outlined text-lg">how_to_reg</span>}
            </button>
          </form>
        </div>
      </div>
