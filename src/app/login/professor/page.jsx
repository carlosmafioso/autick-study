      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-xl shadow-blue-900/5">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-extrabold text-slate-800 mb-1 tracking-tight">Login Professor</h1>
            <p className="text-slate-500 text-[12px] font-medium leading-snug">Acesse o painel de gestão académica</p>
          </div>
