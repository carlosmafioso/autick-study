...
const getTitleFromPath = (path) => {
  switch (path) {
    case '/': return 'Análise de Performance';
    ...
    case '/painel': return 'Painel de Controle';
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col min-w-0 w-full">
        ...
        <main className="md:ml-56 pt-[72px] pb-6 px-4 md:px-5 min-h-screen animate-fade-in" key={location.pathname}>
          <Outlet />
        </main>
      </div>
    </div>
